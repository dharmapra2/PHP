            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php 
                        ...
                        ?>
                    <h2 class="page-heading text-bold">Search : <?php echo $search_term;?></h2>
                        <?php 
                            include "config.php";
                            if(isset($_GET['search'])){
                                $search_term=mysqli_real_escape_string($conn,$_GET['search']);
                                // this function for security purpose.
                               }
                        ...
                        $result1= mysqli_query($conn,$sql1)or die('<p class="col-md"><h3 class="text-center font-weight-bold">Search Failed.</h3</p>');
